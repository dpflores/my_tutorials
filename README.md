...
Update: A pesar de ello sigo teniendo problemas jasjaj, así que cuando creen el archivo ya sea simulink u otro, recomiendo abrir con el filemanager haciendo anticlick en la parte izquierda donde se ven los folders.
